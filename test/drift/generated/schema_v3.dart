...
class StudyQueueItems extends Table with TableInfo {
  ...
  late final GeneratedColumn<int> hintShown = GeneratedColumn<int>(
    'hint_shown',
    aliasedName,
    false,
    type: DriftSqlType.int,
  ...
  late final GeneratedColumn<int> meaningSlot = GeneratedColumn<int>(
    'meaning_slot',
    aliasedName,
    true,
    type: DriftSqlType.int,
...
class StudyGuessOptions extends Table with TableInfo {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  StudyGuessOptions(this.attachedDatabase, [this._alias]);
  late final GeneratedColumn<String> sessionId = GeneratedColumn<String>(
    'session_id',
    aliasedName,
    false,
  ...
  late final GeneratedColumn<String> mode = GeneratedColumn<String>(
    ...
    defaultValue: const CustomExpression('\'guess\''),
  );
  late final GeneratedColumn<int> round = GeneratedColumn<int>(
    'round',
    aliasedName,
  ...
  late final GeneratedColumn<String> optionCardId = GeneratedColumn<String>(
    'option_card_id',
    aliasedName,
    false,
    type: DriftSqlType.string,
  ...
  @override
  String get actualTableName => $name;
  static const String $name = 'study_guess_options';
  @override
  ...
  List<Set<GeneratedColumn>> get uniqueKeys => [
    {sessionId, mode, round, cardId, optionCardId},
  ];
  @override
  Never map(Map<String, dynamic> data, {String? tablePrefix}) {
    throw UnsupportedError('TableInfo.map in schema verification code');
  ...
  @override
  StudyGuessOptions createAlias(String alias) {
    return StudyGuessOptions(attachedDatabase, alias);
  }
...
class DatabaseAtV3 extends GeneratedDatabase {
  ...
  late final StudyGuessOptions studyGuessOptions = StudyGuessOptions(this);
  late final Index idxStudyGuessOptionsOption = Index(
  ...
  late final Index idxCardDeleteBatch = Index(
  ...
  late final Index idxDeckDeleteBatch = Index(
  ...
  StreamQueryUpdateRules get streamUpdateRules => const StreamQueryUpdateRules([
    ...
    WritePropagation(
      ...
      result: [TableUpdate('study_guess_options', kind: UpdateKind.delete)],
    ),
    WritePropagation(
      on: TableUpdateQuery.onTableName(
        'study_queue_items',
