...
- Every Markdown file under `docs/shared/ui/screen-handoff/` starts with the line `<!-- Hand-written screen handoff. Not generated by tools/docs/split_handoff.py. -->`.
...
**Files:**
- Create: `docs/shared/ui/screen-handoff/img/01-deck-list/*.png` (40 files)
- Create: `docs/shared/ui/screen-handoff/img/02-review-algorithm/*.png` (18)
- Create: `docs/shared/ui/screen-handoff/img/04-library-search/*.png` (10)
- Create: `docs/shared/ui/screen-handoff/img/07-card-list/*.png` (26)
...
Run: `find docs/shared/ui/screen-handoff/img -name '*.png' | wc -l; du -sh docs/shared/ui/screen-handoff/img`
...
```bash
git add docs/shared/ui/screen-handoff/img
...
**Files:**
- Create: `docs/shared/ui/screen-handoff/00-index.md`
...
```bash
git add docs/shared/ui/screen-handoff/00-index.md docs/README.md docs/_generated
...
**Files:**
- Create: `docs/shared/ui/screen-handoff/01-deck-list.md`
...
Run:
```bash
cd docs/shared/ui/screen-handoff && grep -o 'img/[^)]*\.png' 01-deck-list.md | sort -u | while read f; do [ -f "$f" ] || echo "missing $f"; done; cd -
```
Expected: no output.
...
```bash
git add docs/shared/ui/screen-handoff/01-deck-list.md
...
**Files:**
- Create: `docs/shared/ui/screen-handoff/02-review-algorithm.md`
- Create: `docs/shared/ui/screen-handoff/04-library-search.md`
...
Run:
```bash
cd docs/shared/ui/screen-handoff && for f in 02-review-algorithm.md 04-library-search.md; do grep -o 'img/[^)]*\.png' "$f"; done | sort -u | while read f; do [ -f "$f" ] || echo "missing $f"; done; cd -
```
Expected: no output.
...
```bash
git add docs/shared/ui/screen-handoff/02-review-algorithm.md docs/shared/ui/screen-handoff/04-library-search.md
...
**Files:**
- Create: `docs/shared/ui/screen-handoff/07-card-list.md`
...
Run:
```bash
cd docs/shared/ui/screen-handoff && grep -o 'img/[^)]*\.png' 07-card-list.md | sort -u | while read f; do [ -f "$f" ] || echo "missing $f"; done; cd -
```
Expected: no output.
...
```bash
git add docs/shared/ui/screen-handoff/07-card-list.md
...
find docs/shared/ui/screen-handoff/img -name '*.png' | wc -l
cd docs/shared/ui/screen-handoff && grep -ho 'img/[^)]*\.png' *.md | sort -u | while read f; do [ -f "$f" ] || echo "missing $f"; done; cd -
git status --short
```
