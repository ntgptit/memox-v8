...
| **Purpose** | Đặc tả luồng người dùng của đối tượng TAG, dưới ID vĩnh viễn `UC-TAG-nnn` |
| **Scope** | Luồng quản lý tag và lọc thẻ theo tag. |
| **Source of truth for** | UC-TAG-nnn · main/alternative/error flow · UI state matrix |
...
**Business rules:** BR-TAG-001, BR-TAG-002, BR-DECK-015, BR-CARD-012, BR-TRANSFER-009, BR-TAG-003, BR-TAG-004,
BR-TAG-005, BR-TAG-006, BR-TAG-007, BR-TAG-008, BR-TAG-009, BR-TAG-010, BR-TAG-011
