...
| **Purpose** | Đặc tả luồng người dùng của đối tượng TRASH, dưới ID vĩnh viễn `UC-TRASH-nnn` |
| **Scope** | Luồng Trash và khôi phục item đã xoá. |
| **Source of truth for** | UC-TRASH-nnn · main/alternative/error flow · UI state matrix |
...
**Business rules:** BR-TRASH-001…BR-TRASH-012, và BR-DECK-001, BR-DECK-009, BR-DECK-010, BR-DECK-017, BR-DECK-018, BR-SRS-006,
