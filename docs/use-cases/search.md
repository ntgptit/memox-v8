# Use cases — Tìm kiếm toàn thư viện

| | |
|---|---|
| **Status** | frozen for MVP |
| **Purpose** | Đặc tả luồng người dùng của đối tượng SEARCH, dưới ID vĩnh viễn `UC-SEARCH-nnn` |
| **Scope** | Luồng tìm kiếm toàn thư viện. |
| **Source of truth for** | UC-SEARCH-nnn · main/alternative/error flow · UI state matrix |
...
**Business rules:** BR-SEARCH-001, BR-SEARCH-002, BR-SEARCH-003, BR-SEARCH-004, BR-SEARCH-005, BR-SEARCH-006, BR-SEARCH-007,
