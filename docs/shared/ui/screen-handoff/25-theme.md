...
| Three cards side by side at any size | One card per line when a word of a name or hint would not fit its third (large text, Vietnamese) | Build audit 2026-09-26; the tray's rule, UI-base row 127 |
