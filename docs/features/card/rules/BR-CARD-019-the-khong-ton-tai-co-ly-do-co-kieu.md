...
**Liên quan:** BR-PRIVACY-003, BR-CARD-011

> ⚠️ OPEN QUESTION: rule trích BR-PRIVACY-003 cho ý "MUST NOT lộ id, đường dẫn hay SQL", nhưng BR-PRIVACY-003 là "Media MUST lưu trong thư mục riêng của ứng dụng". Không BR riêng tư nào phát biểu ý này. Nguồn: `business-rules/card.md` BR-CARD-019 · `business-rules/privacy.md` BR-PRIVACY-003. (Plan OQ-5)
